...
AWS_IOT_ENDPOINT = "a3c3u73p81vtzu-ats.iot.ap-south-1.amazonaws.com"  # Replace with your AWS IoT endpoint
CLIENT_ID = "588738591572"
CA_CERT = "Certificates/AmazonRootCA1.pem"  # CA certificate
DEVICE_CERT = "Certificates/85f39fba05abec9457589878420f32e9cf0c55dc3ec71944b516d7eb78575ce9-certificate.pem.crt"  # Device certificate
PRIVATE_KEY = "Certificates/85f39fba05abec9457589878420f32e9cf0c55dc3ec71944b516d7eb78575ce9-private.pem.key"  # Device private key

# Create an AWS IoT MQTT client instance
mqtt_client = AWSIoTMQTTClient(CLIENT_ID)
mqtt_client.configureEndpoint(AWS_IOT_ENDPOINT, 8883)
mqtt_client.configureCredentials(CA_CERT, PRIVATE_KEY, DEVICE_CERT)
